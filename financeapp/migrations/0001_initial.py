    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('proof_of_payment', models.FileField(blank=True, null=True, upload_to='transaction_proofs/')),
                ('proof_verified', models.BooleanField(default=False)),
                ('proof_verified_at', models.DateTimeField(blank=True, null=True)),
                ('id_verified', models.BooleanField(default=False)),
                ('id_verification_method', models.CharField(blank=True, max_length=50)),
                ('id_verified_at', models.DateTimeField(blank=True, null=True)),
                ('commission_tier', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='transactions', to='financeapp.commissiontier')),
                ...
                ('id_verified_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='id_verified_transactions', to=settings.AUTH_USER_MODEL)),
                ...
                ('proof_verified_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='verified_transactions', to=settings.AUTH_USER_MODEL)),
                ('subscription', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='transactions', to='financeapp.subscriptionplan')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('hold_type', models.CharField(choices=[('project_milestone', 'Project Milestone'), ('obsp_purchase', 'OBSP Purchase'), ('auto_pay_commitment', 'Auto-Pay Commitment'), ('subscription', 'Subscription Hold'), ('dispute', 'Dispute Hold'), ('manual', 'Manual Hold'), ('obsp_stake', 'OBSP Stake')], max_length=32)),
                ('amount', models.DecimalField(decimal_places=2, max_digits=12, validators=[django.core.validators.MinValueValidator(Decimal('0.01'))])),
                ('status', models.CharField(choices=[('active', 'Active'), ('released', 'Released'), ('expired', 'Expired'), ('cancelled', 'Cancelled')], default='active', max_length=20)),
                ...
                ('milestone', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='wallet_holds', to='core.milestone')),
                ('obsp_response', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='wallet_holds', to='OBSP.obspresponse')),
                ('project', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='wallet_holds', to='core.project')),
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('wallet', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='holds', to='financeapp.wallet')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('amount', models.DecimalField(decimal_places=2, max_digits=12, validators=[django.core.validators.MinValueValidator(Decimal('0.01'))])),
                ('transaction_type', models.CharField(choices=[('deposit', 'Deposit'), ('withdrawal', 'Withdrawal'), ('transfer', 'Transfer'), ('payment', 'Payment'), ('refund', 'Refund'), ('hold', 'Hold'), ('release', 'Release'), ('commission', 'Commission'), ('subscription', 'Subscription Fee'), ('obsp_purchase', 'OBSP Purchase')], max_length=20)),
        ...
        migrations.AddIndex(
            model_name='hold',
            index=models.Index(fields=['wallet', 'status'], name='financeapp__wallet__295d6b_idx'),
        ),
        migrations.AddIndex(
            model_name='hold',
            index=models.Index(fields=['hold_type', 'status'], name='financeapp__hold_ty_2be8ad_idx'),
        ),
        migrations.AddIndex(
            model_name='hold',
            index=models.Index(fields=['created_at'], name='financeapp__created_0bd9a2_idx'),
        ),
        migrations.AddIndex(
            model_name='hold',
            index=models.Index(fields=['expires_at'], name='financeapp__expires_485d80_idx'),
        ),
        migrations.AddIndex(
