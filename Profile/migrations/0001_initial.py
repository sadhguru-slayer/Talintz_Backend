    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('department', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Profile.department')),
            ],
        ),
        migrations.CreateModel(
            name='Education',
            fields=[
                ...
                ('department', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Profile.department')),
                ('institution', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Profile.institution')),
            ],
        ),
        migrations.CreateModel(
            name='Feedback',
            fields=[
                ...
                ('obsp', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='OBSP.obsptemplate')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('current_level', models.CharField(choices=[('Bronze', 'Bronze'), ('Silver', 'Silver'), ('Gold', 'Gold')], default='Bronze', max_length=10)),
                ('current_sub_level', models.PositiveIntegerField(default=1)),
                ('addresses', models.ManyToManyField(blank=True, related_name='freelancer_addresses', to='Profile.address')),
                ('bank_details', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='freelancer_bank', to='Profile.bankdetails')),
                ('certifications', models.ManyToManyField(blank=True, related_name='freelancer_certs', to='Profile.certification')),
                ('company', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='freelancer_company', to='Profile.companydetails')),
                ('education', models.ManyToManyField(blank=True, related_name='freelancer_education', to='Profile.education')),
                ('skills', models.ManyToManyField(blank=True, related_name='freelancer_skills', to='core.skill')),
                ...
                ('institution', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='current_students', to='Profile.institution')),
                ('portfolio_items', models.ManyToManyField(blank=True, related_name='freelancer_portfolio', to='Profile.portfolioitem')),
                ('verification_documents', models.ManyToManyField(blank=True, related_name='freelancer_documents', to='Profile.verificationdocument')),
            ],
        ),
        migrations.CreateModel(
            name='ClientProfile',
            fields=[
                ...
                ('company', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='company_details', to='Profile.companydetails')),
                ('verification_documents', models.ManyToManyField(blank=True, related_name='client_documents', to='Profile.verificationdocument')),
            ],
            options={
